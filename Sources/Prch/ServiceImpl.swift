...
//  CoderType: Coder,
//  SessionType: GenericSession,
//  RequestBuilderType: RequestBuilder,
//  AuthorizationContainerType: AuthorizationContainer
// >: GenericService, HeaderProvider where
//  SessionType.GenericSessionRequestType == RequestBuilderType.SessionRequestType,
//  RequestBuilderType.SessionRequestType.DataType == CoderType.DataType,
//  SessionType.GenericSessionResponseType.DataType == CoderType.DataType {
...
//    -> RequestType.SuccessType where RequestType: GenericRequest {
...
////    )
//
//      let data = try await session.data(request: request, withBaseURL: baseURLComponents, withHeaders: headers, usingEncoder: coder)
//
